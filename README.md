...
> Trata-se de um mini projeto simples programado em **Java**, que visa usar os principais conceitos da POO (Encapsulamento, herança e polimorfismo) em um sistema de pedido associado a cliente.
...
* Você precisa compreender enumeração
* Você precisa compreender o conceito de associação
* Você precisa compreender a classe StringBuilder
...
```
<git clone git@github.com:AlissonWenceslau/client-order-simple.git >
```
###### Próximo passo
